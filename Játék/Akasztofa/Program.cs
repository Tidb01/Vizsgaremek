        ...
        class Program
        {
...

            {
                ...
                using (var connect = new SqlConnection(connectionString))
                {
                    ...
                    Console.WriteLine("Ezaa");
                    
                }
                Console.WriteLine("Eza");
                Console.Read();
                ...
                DataRow randomW = szotar[index];
                Console.WriteLine(randomW.ToString());
                Console.Read();
                foreach (char c in randomW.ToString())
                {
                    Console.Write(" _ ");

                }
                int guessed = randomW.ToString().Length;
                int wrong = 0;
